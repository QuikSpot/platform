  ...
  return (
    <div className="fixed top-0 inset-x-0 z-50 flex justify-center pointer-events-none px-3 sm:px-4">
      <motion.nav
        ...
        className={cn(
          'pointer-events-auto w-full flex items-center justify-between border backdrop-saturate-150',
          'transition-[background-color,border-color,box-shadow,backdrop-filter] duration-500 ease-[cubic-bezier(0.16,1,0.3,1)]',
          scrolled
            ? 'mt-3 max-w-3xl rounded-full px-5 py-2.5 bg-white/70 backdrop-blur-2xl border-white/60 shadow-[0_8px_32px_-4px_rgba(15,23,42,0.16),inset_0_1px_0_rgba(255,255,255,0.7)]'
            : 'mt-0 max-w-7xl rounded-b-2xl px-4 py-4 sm:px-6 bg-white/25 backdrop-blur-md border-transparent shadow-none'
        )}
      >
        {/* Logo */}
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            style={{ maxWidth: scrolled ? '48rem' : undefined, marginInline: 'auto' }}
          >
